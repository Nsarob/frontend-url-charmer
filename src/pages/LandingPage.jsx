    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
      ...
      <nav className="flex justify-between items-center py-4 px-8 bg-white shadow-sm">
        ...
        <div className="flex items-center space-x-4">
          ...
          <a href="/register" className="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition">Sign Up</a>
        </div>
      </nav>
      ...
      <div className="max-w-5xl mx-auto px-4 pt-20 pb-16 text-center">
        ...
        <p className="text-xl text-gray-600 mb-1 max-w-3xl mx-auto">
          Create shortened URLs that are easy to share, track, and manage with our professional link shortening service.
        </p>
        
        {/* URL Shortener Form */}
        <div className="bg-white p-0 rounded-xl shadow-md max-w-3xl mx-auto">
